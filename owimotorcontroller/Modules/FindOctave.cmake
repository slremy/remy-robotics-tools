...
# Finally the path and the library itself  HACK!!!
find_path(
    OCTAVE_INCLUDE_PATH
    oct.h
    ${OCTAVE_INCLUDE_DIRS}
    )
find_library(OCT_LIBRARY
  NAMES octave
  PATHS ${_mkoctfile_ldirs}
)
find_library(OCTINTERP_LIBRARY
  NAMES octinterp
  PATHS ${_mkoctfile_ldirs}
)
set(OCTAVE_LIBRARIES  ${OCT_LIBRARY} ${OCTINTERP_LIBRARY} )
